...
| 5G-1B | Holding→payout lifecycle for RCCL/DCL cruise deposits (release event) | Deferred | Not started (known accepted AMEX-Savings offset until then); relates to 5G-1E |
