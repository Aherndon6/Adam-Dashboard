...
| 5G-1C-2 | Goal Funding State Integrity (`goal_funding_snapshots` + overwrite-at-anchor overlay + RPC + first opening_anchor + golden-master) | Pre-Alaska if freeze checkpoint met | **HOLD / CONDITIONAL GO** — Fable-approved (Option B); R1–R13 folded into `docs/phase-5g-1c-plan-2026-07-08.md`; prod DDL gated on ~Jul 21–22 checkpoint (else post-Aug-10) |
| 5G-1D | Weekly Closeout Goal Attribution (prefilled one-click snapshot write at closeout, calls the 5G-1C-2 RPC) | Post-1C-2 | Not started |
