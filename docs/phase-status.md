...
**Phase-map reconciliation — PENDING Adam decision (D5, not executed here):** the two-slice 5G-1C plan and the brief roadmap propose inserting 5G-1D (Weekly Closeout Goal Attribution) / 5G-1E (Account Purpose / Holding Bucket Integrity) / 5G-1F (July Month-End Close) and relabeling 5G-2 to "Planned Outflows Foundation." The table below still reflects the pre-5G-1C map (5G-2 = Derived Account Allocation view). This renumber is a roadmap decision left to Adam; the table is unchanged until he confirms.
